...
\titlePL{Klasyfikacja gestów języka migowego przy użyciu Sign Language MNIST}
\titleEN{Laboratory Report: Hand Sign Classification using Sign Language MNIST}

\shorttitlePL{Klasyfikacja języka migowego przy użyciu Sign Language MNIST}
...
\include{chapters/cel_projektu}
\clearpage
\include{chapters/opis_implementacja}
\clearpage
\include{chapters/implementacja}
\clearpage
\include{chapters/eksperymenty_wyniki}
\clearpage
\include{chapters/wyniki_analiza}
\clearpage
\include{chapters/wnioski}
\clearpage
\include{chapters/instrukcja_uruchomienia}
